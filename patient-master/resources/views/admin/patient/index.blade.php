...
//        var myAwesomeSortFn = function(a,b) {
            ...
            var columnDefs = [
                ...
                { displayName: 'Motor Impairment', field: 'diagnosis[0].motor_impairment', enableCellEdit: false, minWidth: 150, width: 150},
                { displayName: 'Abnormal reflexest', field: 'diagnosis[0].abnormal_reflexes', enableCellEdit: false, minWidth: 150, width: 150},
                { displayName: 'Sensory Impairment', field: 'diagnosis[0].sensory_impairment', enableCellEdit: false, minWidth: 150, width: 150},
                ...
                { displayName: 'Surgery', field: 'diagnosis.surgery', minWidth: 190, width: 190, enableCellEdit: false},
                { displayName: 'Date of surgery', field: 'diagnosis[0].date_of_surgery', minWidth: 190, width: 190, enableCellEdit: false},
                { displayName: 'Physiotherapy', field: 'diagnosis[0].physiotherapy', minWidth: 190, width: 190, enableCellEdit: false},
                { displayName: 'Analgesics', field: 'diagnosis[0].analgesics', minWidth: 190, width: 190, enableCellEdit: false},
                { displayName: 'Orthosis', field: 'diagnosis[0].orthosis', minWidth: 190, width: 190, enableCellEdit: false},
                { displayName: 'Epidural injection', field: 'diagnosis.epidural_injection', minWidth: 190, width: 190, enableCellEdit: false},
